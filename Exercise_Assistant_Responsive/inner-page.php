...
// for  picking a user file  .......................//
function clickFunction()
{
 	document.getElementById("userfile").click();
}
/*	<!--DatePicker action code-->
$(function() {
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form"  data-toggle="validator" method="post" name="form1" id="form1">
                ...
                <div class="form-group">
                  <div class="select-field select-field custom-dropdown custom-dropdown--white select-field-2 no-margin-right"  >
                    <select class="form-control custom-dropdown__select custom-dropdown__select--white" name="doc_type" id="doc_type" required>
                      ...
                      <option value="blue">Discharge Summary (DS);</option>
                      <option value="green">Operative Note or Report (OP),</option>
                      <option value="orange">Consultation Report (CONSULTS).</option>
                      <option value="red"> Pathology Report (PATH)</option>
                      <option value="yellow">Radiology Report (x rays or radiographs).</option>
                      <option value="white">others </option>
                    </select>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="date" id="datepicker"  class="form-control"  placeholder="Date" required>
                </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form"  method="post" name="form2" id="form2" action='Medicine_Fun.php'>
                ...
                <div class="form-group">
                  <label> Stock
                    <input type="checkbox" name="click_stock" id="click_stock">
                  </label>
                </div>
               ...
               <!-- <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input  type="time" data-minlength="6"  placeholder="Reminder" required name='daliy_reminder' id='daliy_reminder'></input>
                                  <div class="checklist">
                                  <label>Sun</label>
...
function validate_form1()
{
	...
	{    
		...
		$.ajax({
			...
			type: 'POST',
			dataType: 'json',
			data: {},//  faryal  agr yaha  pura pas karao gi variables  tou waha  post hungy otherwise  pura  form submit hua hua jasy nechy wala method h
		})
		.done(function(data) {
...
function validate_form2()
{
	...
	var daliy_reminder= document.getElementById('daliy_reminder').value;
